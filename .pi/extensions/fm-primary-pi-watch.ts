...
const primaryScopeLib = `${fmRoot}/bin/fm-primary-scope-lib.sh`;
...
export default function (pi: ExtensionAPI) {
  ...
  function startArm(predecessorArmPid = ""): ArmResult {
    if (!primaryScopeMatches()) return { ok: false, message: "watcher: not armed - Pi watcher continuity is inactive outside a primary Firstmate home" };
