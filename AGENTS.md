...
config/signing-agent  absolute Unix socket for the configured SSH commit-signing agent; LOCAL, gitignored, inherited by secondmate homes; see docs/configuration.md "Signed no-mistakes fixes"
